- **Binary digits (or Base 2 values) are a foundational segment of [[Subnets|subnets]]**
- Binary refers to a language that only uses 0s or 1s.
	...
	- A ***hextet*** refers to 16 bits
	- Bits and bytes are more relevant in [[IPv4 Addressing]]
	- Nibbles and hextets are more relevant in [[IPv6 addressing]]
- Usually, the amount of leading 0s showcases the amount of bits that the placeholder has (7 0s and a 1 shows that there are 8 bits)
