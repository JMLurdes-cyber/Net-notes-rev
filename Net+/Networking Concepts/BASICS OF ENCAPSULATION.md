...
- We call **segment** to each fragment encapsulated in this layer.

## [[Network Layer|Layer 3: Network Layer]]
- This layer gives the payload an **[[Network Layer Header|IP Header]]**.
- We call **packet** to each fragment encapsulated in this layer.

## [[DATA LINK LAYER|Layer 2: Data Link Layer]]
- This layer encapsulates data into [[Data Link Frames|Frames]]
---
[[INTRODUCTION TO IP]]
