...
- Usually two bits of information are added:
	- **Frame Check Sequence (FCS/[[Cyclical Redundancy Check|CRC]] (Checksum))**: A (usually) 4 bytes mathematical number calculated by the sender based on the message. This number gets calculated twice, and if the results don't match the frame is considered "faulty", and discarded.
