...
- Several DGs may be found within a single network by using the [[First Hop Redundancy Protocols (FHRP)]] and then creating a [[Virtual IP  Addresses (VIP)]] that can be used by several routers.
