- Unique number that is burned into a device's network hardware by it's manufacturer, serving as a "name tag" to identify it.
- [[Binary Math|48 bit]] number, written in [[Hexadecimal Math|12 hexadecimal values]]
